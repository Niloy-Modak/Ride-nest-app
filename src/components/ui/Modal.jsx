...
const Modal = ({ isOpen, onClose, children, cls }) => {
    useEffect(() => {
        if (isOpen) {
    ...
    return (
        ...
        >
            ...
            >
                <button
                    onClick={onClose}
                    className="absolute top-2 right-2 text-gray-600 hover:text-red-500 hover:scale-105 transition-all text-xl cursor-pointer"
                >
                    <RxCross2 size={22} />
                </button>
                {children}
